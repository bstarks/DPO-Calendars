/*
	...
	TO DO:
		1) fix day & month entries to use date object.
		2) 
*/
...
(function (id0, undefined) {
		...
		var utHolidays = cfg.utHolidays,
			...
			getDate = function (holiday, year) {
				...
				if (day === "Day") {
					...
					//(e.g. If Jan 1 falls on Sat, Fri Dec 31 will be the day off)
					if (adjHoliday === 0) {
						mo = (mo === 0) ? 11 : mo - 1; // if mo is Jan, make it Dec. Else roll mo back by one
	...
	function main() {
		...
		document.getElementById('wcal_dropdown_arrow').onmouseover = function () { $('#wcal_dropdown_arrow').classList.toggle('wcal_active') }
	}
